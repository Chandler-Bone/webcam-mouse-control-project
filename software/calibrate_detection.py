...
class CalibrateDetection:
    ...
    def loadGUI(self):
        ...
        self.scale1.configure(from_='0', orient='horizontal', to='255', variable=self.upper_hue)
        ...
        self.scale2.configure(from_='0', orient='horizontal', to='255', variable=self.lower_hue)
        ...
        self.scale3.configure(from_='0', orient='horizontal', to='255', variable=self.upper_saturation)
        ...
        self.scale4.configure(from_='0', orient='horizontal', to='255', variable=self.lower_saturation)
        ...
        self.scale5.configure(from_='0', orient='horizontal', to='255', variable=self.upper_value)
        ...
        self.scale6.configure(from_='0', orient='horizontal', to='255', variable=self.lower_value)
    ...
    def updateHSV(self, scale_value):
        ...
        self.lower_skin = np.array([self.lower_hue.get(), self.lower_saturation.get(), self.lower_value.get()])
        self.upper_skin = np.array([self.upper_hue.get(), self.upper_saturation.get(), self.upper_value.get()])
    ...
    def initalCalibration(self):
        ...
        while(True):
            ...
            res = cv.putText(res, "Click around your hand till its nearly completely black and press the key \'f\'", (19, 19), cv.FONT_HERSHEY_PLAIN, 1.25, (0,0,0),1,cv.LINE_AA)
            res = cv.putText(res, "Click around your hand till its nearly completely black and press the key \'f\'", (21, 21), cv.FONT_HERSHEY_PLAIN, 1.25, (0,0,0),1,cv.LINE_AA)
            res = cv.putText(res, "Click around your hand till its nearly completely black and press the key \'f\'", (20, 20), cv.FONT_HERSHEY_PLAIN, 1.25, (0,0,255),1,cv.LINE_AA)
